...
_BANKMICROSERVICE = _descriptor.ServiceDescriptor(
  name='BankMicroService',
  full_name='unary.BankMicroService',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  ...
  _descriptor.MethodDescriptor(
    name='MsgDelivery',
    full_name='unary.BankMicroService.MsgDelivery',
    index=0,
...
_sym_db.RegisterServiceDescriptor(_BANKMICROSERVICE)

DESCRIPTOR.services_by_name['BankMicroService'] = _BANKMICROSERVICE
